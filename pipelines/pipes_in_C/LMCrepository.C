...
void FillDataM(Number &dm_mass){
  ...
  // Components files
  TString dir = "/home/queenmab/DATA/M31/Obs_";
  TString dir_PS = "/home/queenmab/DATA/M31/Obs_PS";
  ...
  filename = "/home/queenmab/DATA/M31/Obs_Irf+CR_TRUNC1TeV+DiffuseSources+1PS/cntcube_LMC_Irf+CR_TRUNC1TeV+DiffuseSources+1PS_KSPpointing_v2_.fits";
  //filename = "/home/queenmab/DATA/M31/Obs_Irf+CR+DiffuseSources+1PS/cntcube_LMC_Irf+CR+DiffuseSources+1PS_KSPpointing_v2_.fits";
  //filename = "/home/queenmab/DATA/M31/Obs_Irf+CR+DiffuseSources+PS/cntcube_LMC_Irf+CR+DiffuseSources+PS_KSPpointing_v2_.fits";
  ...
  /*if (dm_mass==1) filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_300h_40ebins_002binning.fits";
  else if(dm_mass==0.500) filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_300h_40ebins_025binning.fits";
  else*/// filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_300h_40ebins_01binning.fits";
  //filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_300h.fits";
  if (dm_mass == 0) filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_dm_PowerLaw_003-100_KSP.fits";
  //else filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_300h.fits";
  else filename = "/home/queenmab/DATA/M31/Obs_DM/modcube_"+modelname+"_003-100_KSP_v2.fits";
...
void DataSim(VM &data){
  ...
  TString filename = "/home/queenmab/DATA/M31/Obs_Irf+CR_TRUNC1TeV+DiffuseSources+1PS/modcube_LMC_Irf+CR_TRUNC1TeV+DiffuseSources+1PS_KSPpointing_v2_.fits";
  //TString filename = "/home/queenmab/DATA/M31/Obs_Irf+CR+DiffuseSources+1PS/modcube_LMC_Irf+CR+DiffuseSources+1PS_KSPpointing_v2_.fits";
  //TString filename = "/home/queenmab/DATA/M31/Obs_Irf+CR+DiffuseSources+PS/modcube_LMC_Irf+CR+DiffuseSources+PS_KSPpointing_v2_.fits";
