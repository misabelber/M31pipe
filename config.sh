...
DATA_PATH='/home/queenmab/DATA/M31/' #Folder to store heavy data files (Observations and datacubes)
...
M31_PATH=`pwd` #THIS FOLDER IS M31 FOLDER

var=`grep -r -h 'M31_PATH = ' $LMC_PATH/tools/tools_in_py/ | head -1`
#tr -d $var 'M31_PATH'
